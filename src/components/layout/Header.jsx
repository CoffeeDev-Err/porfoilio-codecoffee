...
function ThemeIcon({ theme }) {
  if (theme === 'dark') {
    return (
      <svg viewBox="0 0 24 24" className="theme-toggle-icon h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
  ...
  return (
    <svg viewBox="0 0 24 24" className="theme-toggle-icon h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
